...
public class RiceSerializable {
    private static final Charset CHARSET_UTF8 = Charset.forName("UTF-8");

    public static byte[] riceProtocolEncode(RiceRemoteContext cmd) {
        // String remark
    ...
    public static RiceRemoteContext riceProtocolDecode(final byte[] headerArray) {

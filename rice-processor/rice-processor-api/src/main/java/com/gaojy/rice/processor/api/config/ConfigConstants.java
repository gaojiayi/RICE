...
public class ConfigConstants {
    ...
    public static final String RICE_CONTROLLER_PORT = "rice.controller.port";
    public static final String RICE_PROCESSOR_SCAN_PACKAGES = "rice.processor.scan.packages";
}
